...
use TypiCMS\Modules\Core\Http\Controllers\PageSubSectionsAdminController;
use TypiCMS\Modules\Core\Http\Controllers\PageSubSectionsApiController;
...
Route::middleware('admin')->prefix('admin')->name('admin::')->group(function (Router $router) {
    ...
    //page sub sections
    $router->get('pages/{page}/sections/{section}/subsections/create', [PageSubSectionsAdminController::class, 'create'])->name('create-page_sub_sections');//->middleware('can:create page_sub_sections');
    $router->get('pages/{page}/sections/{section}/subsections/{subsection}/edit', [PageSubSectionsAdminController::class, 'edit'])->name('edit-page_sub_sections');//->middleware('can:read page_sub_sections');
    $router->post('pages/{page}/sections/{section}/subsections', [PageSubSectionsAdminController::class, 'store'])->name('store-page_sub_sections');//->middleware('can:create page_sub_sections');
    $router->put('pages/{page}/sections/{section}/subsections/{subsection}', [PageSubSectionsAdminController::class, 'update'])->name('update-page_sub_sections');//->middleware('can:update page_sub_sections');
    $router->post('pages/{page}/sections/{section}/subsections/sort', [PageSubSectionsAdminController::class, 'sort'])->name('sort-page_sub_sections');
    $router->get('subsections', [PageSubSectionsAdminController::class, 'index'])->name('index-page_sub_section')->middleware('can:read page_sub_sections');
    $router->delete('sections/{section}/subsections/{subsection}', [PageSubSectionsAdminController::class, 'destroyMultiple'])->name('destroy-page_sub_sections');//->middleware('can:delete page_sub_sections');
...
Route::middleware(['api', 'auth:api'])->prefix('api')->group(function (Router $router) {
    ...
    $router->get('page/{page}/sections/{section}/subsections', [PageSubSectionsApiController::class, 'index']);//->middleware('can:read page_sub_sections');
    $router->patch('pages/{page}/sections/{section}/subsections/{subsection}', [PageSubSectionsApiController::class, 'updatePartial']);//->middleware('can:update page_sections');
    $router->delete('pages/{page}/sections/{section}/subsections/{subsection}', [PageSubSectionsApiController::class, 'destroy']);//->middleware('can:delete page_sections');
});
