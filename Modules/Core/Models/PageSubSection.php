...
class PageSubSection extends Base implements Sortable
{
    use HasFiles;
    use HasTranslations;
    use Historable;
...
//    }
    ...
    {
        $route = 'admin::edit-page_sub_section';
        if (Route::has($route)) {
            return route($route, [$this->section_id, $this->id]);
        }
